...
async def cmd_start(message: types.Message, command: CommandObject = None):
    ...
    # Referral — obunasiz ham, faqat yangi foydalanuvchi bo'lsa va ref_id bo'lsa
    if ref_id and user.get("is_new"):
        try:
            # referral_count ni oshir va ball qo'sh
            conn = get_conn()
            cur  = conn.cursor()
            cur.execute(
            ...
            await bot.send_message(
                ...
                f"━━━━━━━━━━━━━━━\n"
                f"⭐️ <b>+{REFERRAL_BONUS} ball</b> hisoblangiz qo'shildi!"
            )
        except Exception:
            pass
