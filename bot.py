...
async def grammar_answer(callback: types.CallbackQuery, state: FSMContext):
    ...
    if next_index >= total:
        ...
        await callback.message.edit_text(
            ...
            f"━━━━━━━━━━━━━━━━━━\n\n"
           f"{'🔥 Zo\'r! Siz grammatikani bilasiz!' if percent>=80 else '💪 Tushuntirishni qayta o\'qing va urinib ko\'ring!'}" # Bu yerda sleshlarni olib tashlang va tashqi qo'shtirnoqni tekshiring.
            reply_markup=kb
        )
    else:
