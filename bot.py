...
async def _send_battle_question(uid: int, battle: dict):
    ...
    txt = (
        ...
        f"🔵 Siz: <b>{my_score}</b>  🔴 Raqib: <b>{opp_score}</b>\n\n"
        f"⏱ 20 sekund!\n\n"
        f"━━━━━━━━━━━━━━━━━━\n"
        f"🇬🇧 <b>{correct['word'].upper()}</b>\n"
        f"━━━━━━━━━━━━━━━━━━\n\n"
...
async def _finish_battle(bid: str, reason: str = "complete", winner_id: int = None, loser_id: int = None):
    ...
    if is_bot_battle:
        # Faqat haqiqiy foydalanuvchiga xabar yuboramiz
        # Bot nomi bilan chiroyli natija
        bot_name = bot_profile.get("name", "🤖 Bot")
        if is_draw:
